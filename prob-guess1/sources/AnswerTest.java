...
public class AnswerTest {
	...
	//Answer soln = new Answer(); // This class is tested
	//NumberGuess soln = new NumberGuess();	
	//NumberGuess1 soln = new NumberGuess1();
	NumberGuess2 soln = new NumberGuess2();
	//AtulAditya soln = new AtulAditya();
	//DiptiLenka soln = new DiptiLenka(); 
	...
	public void testUnqualInputLength() {
		...
		// Unequal length inputs: scenario 1		  
		  try {
		     ...
		     System.out.println("Unequal length inputs 1234 123: " + e);
		  }
		  ...
		  try {
			  ...
			  System.out.println("Unequal length inputs 123 1234: " + e);
		  }
